...
export const Header = () => {
  return (
    <header className="fixed top-0 w-full h-[50px] bg-white shadow-md flex items-center px-4">
      ...
      <div className="flex-shrink-0 flex gap-5">
        <button className="w-[118px] h-[32px] bg-white border border-[#69BEEF] text-[#69BEEF] text-[12px] font-bold leading-[15px] tracking-[0.21666669845581055px] text-center rounded-[16px] flex items-center justify-center">
          ログイン
        </button>
